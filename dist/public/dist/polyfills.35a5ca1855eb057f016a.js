      ...
      !function (e) {
        ...
        function Z(e, o, s) {
          ...
          if (e[g] === v) {
            ...
            if (o !== T && s instanceof O && s.hasOwnProperty(g) && s.hasOwnProperty(_) && s[g] !== v) D(s), Z(e, s[g], s[_]);else if (o !== T && "function" == typeof h) try {
          ...
          const O = s ? function (e) {
            ...
            return function () {
              ...
              const k = L && !!R && -1 !== R.indexOf(f),
                    m = C(arguments[2], k);
              if (N) for (let e = 0; e < N.length; e++) if (f === N[e]) return k ? t.call(p, f, d, m) : t.apply(this, arguments);
      ...
      Zone.__load_patch("legacy", e => {
        ...
        !function (e) {
          ...
          function m(e) {
            ...
            const h = i[r] = () => {
              if (i.readyState === i.DONE) if (!o.aborted && i[s] && e.state === k) {
